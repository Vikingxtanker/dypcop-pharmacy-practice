...
export default function HealthScreeningPage() {
  return (
    <>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-4">
              ...
              >
                <div className="card-body text-center p-4">
                  <h5 className="card-title fw-bold">Weekly Updates</h5>
                  <p className="card-text text-muted">
                    View our latest weekly health screening activity updates.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Weekly Updates Image Cards */}
      <section className="py-5">
        <div className="container">
          <h2 className="text-center mb-4">Weekly Updates</h2>
          <div className="row g-4 justify-content-center">
            <div className="col-md-4">
              ...
              >
                <img
                  src="/assets/weekly-update-1.jpg"
                  className="card-img-top"
                  alt="Weekly Update 1"
                  style={{ height: "250px", objectFit: "cover" }}
                />
                <div className="card-body text-center">
                  <p className="card-text fw-semibold">Week 1 Update</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              ...
              >
                <img
                  src="/assets/weekly-update-2.jpg"
                  className="card-img-top"
                  alt="Weekly Update 2"
                  style={{ height: "250px", objectFit: "cover" }}
                />
                <div className="card-body text-center">
                  <p className="card-text fw-semibold">Week 2 Update</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              ...
              >
                <img
                  src="/assets/weekly-update-3.jpg"
                  className="card-img-top"
                  alt="Weekly Update 3"
                  style={{ height: "250px", objectFit: "cover" }}
                />
                <div className="card-body text-center">
                  <p className="card-text fw-semibold">Week 3 Update</p>
                </div>
              </div>
            </div>
          </div>
