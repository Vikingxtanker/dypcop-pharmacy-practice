...
export default function DicSectionNavbar() {
      ...
      <div className="container-fluid px-3 d-flex align-items-center justify-content-between">
        ...
        <div className={`collapse navbar-collapse ${isOpen ? "show" : ""}`} id="navbarContent">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item"><Link className="nav-link fw-semibold" href="/dic/dicform">Register</Link></li>
            <li className="nav-item"><Link className="nav-link fw-semibold" href="/dic/guidelines">Guidelines</Link></li>
            <li className="nav-item"><Link className="nav-link fw-semibold" href="/dic/about-us">About Us</Link></li>
          </ul>
        </div>
      </div>
    </nav>
